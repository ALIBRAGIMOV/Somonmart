  ...
  return (
    <div classes={classes.root}>
      <Paper className={classes.paper}>
        <Grid className={classes.grid} container spacing={8}>
          ...
          <Grid item md={3}>
            <List component="nav" aria-label="Main mailbox folders">
              ...
              <ListItem button>
                <Typography component="p" className={classes.listItem}>
                г. Москва, ул. Скадочная 1, стр. 44
                </Typography>
              </ListItem>
              <ListItem button>
                <Typography component="p" className={classes.listItem}>
        ...
        <Grid style={{ padding: "10px" }} container spacing={8}>
          <Grid item md={6}>
            <div className={classes.inline}>
              ...
              <Link href="/">
                    ...
                    <div className="svg">
                        <i>
                        <svg width="260" height="66" viewBox="0 0 260 66" xmlns="http://www.w3.org/2000/svg" className="icon_top">
                <g>
                <title>background</title>
                <rect fill="none" id="canvas_background" height="40" width="260" y="-1" x="-1"/>
                </g>
                <g>
                <title>Layer 1</title>
                <g stroke="null" id="svg_1">
                <g stroke="null" id="svg_2">
                    <path stroke="null" id="svg_3" d="m49.60734,45.31316c4.64213,0 6.90135,-2.3564 6.90135,-5.10554c0,-6.04977 -9.45741,-3.9524 -9.45741,-6.994c0,-1.03615 
          ...
          <Grid item md={3}>
            <Grid container spacing={2}>
              <Grid item md={4}>
                <img height="30" alt="instagram" src={'https://image.flaticon.com/icons/svg/2111/2111463.svg'} />
              </Grid>
              <Grid item md={4}>
                <img height="30" alt="facebook" src={'https://image.flaticon.com/icons/svg/2111/2111398.svg'} />
              </Grid>
              <Grid item md={4}>
                <img height="30" alt="twitter" src={'https://image.flaticon.com/icons/svg/733/733579.svg'} />
              </Grid>
            </Grid>
          </Grid>
        </Grid>
