...
import NavBarLow from "./NavBarLow";
              ...
              <div className={classes.container}>
                ...
                >
                  <ul className="top-bar-menu">
                    <li className="top-bar-menu__item_one active">
                      {" "}
                      <Link href="/about">
                        <a className="city">Главная</a>
                      </Link>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">О Компании</a>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">Продукция на заказ</a>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">Новости</a>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">Доставка и оплата</a>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">Самовывоз</a>
                    </li>
                    <li className="top-bar-menu__item active">
                      {" "}
                      <a className="city">Контакты</a>
                    </li>
                  </ul>
                  <div className="top-bar-cabinet">
                    {!isAuth() && (
                      <React.Fragment>
                        <div className="menu1">
                          <Link href="/signin">
                    ...
                    {isAuth() && isAuth().role === 1 && (
                      <div className="menu1">
                        <Link
                          as={`/adminuse/admin/${isAuth().name}`}
                          href="/adminuse/[admin]/[admindash]"
                        >
                          <a className="sign">
                            <i className="signIco">
                              <img
                    ...
                    {isAuth() && isAuth().role === 0 && (
                      <div className="menu1">
                        <Link
                          as={`/userus/user/${isAuth().name}`}
                          href="/userus/[user]/[userdash]"
                        >
                          <a className="sign">
                            <i className="signIco">
                              <img
                          ...
                          <Link href="/">
                            ...
                            >
                              <i className="signIco">
                                <img
                                  className="img"
                                  src="https://image.flaticon.com/icons/svg/633/633671.svg"
                                />
                              </i>
                              Выход
                            </a>
